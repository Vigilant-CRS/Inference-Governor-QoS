...
│
├── crates/
│   ├── onetimer-core/            # reine Schedulinglogik
│   ├── onetimer-config/          # Schema, Parser, Validator
│   ├── onetimer-protocol-oip/    # OIP v2 DTO/Mapping
│   ├── onetimer-gateway/         # gRPC/HTTP Server
│   ├── onetimer-backend-triton/  # Backend-Adapter
│   ├── onetimer-profiler/        # Runtime-/Interferenzprofile
│   ├── onetimer-metrics/         # Metrics + structured events
│   └── onetimer-cli/             # doctor/profile/serve/bench
│
├── proto/
│   └── oip/
│
...
- Keep onetimer-core free of networking and Triton dependencies.
