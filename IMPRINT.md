...
Legal information under § 5 DDG (Germany) and the contact point for licensing,
pilot enquiries and security reports.
...
Responsible for the content of this repository under § 18 (2) MStV:  
Damir Dulovic, address as above.
...
The software is published under the Business Source Licence 1.1. Evaluation,
development, research, benchmarking, teaching and continuous integration are
free of charge. **Production use requires a commercial licence** from Vigilant
e.K. Four years after a version is first published, that version becomes
...
NVIDIA Triton Inference Server and the NVIDIA container images are **not**
redistributed here; they are obtained from NVIDIA under NVIDIA's own terms. The
licences of all bundled third-party components are listed in
