...
//!
//! OneTimer spricht das Open Inference Protocol, und das ist ein offener
...
/// Eine Erweiterung, auf die OneTimer sich stuetzen kann.
...
/// Die Erweiterungen, auf die OneTimer sich stuetzt.
...
impl Capabilities {
    ...
    /// vorhanden. Das ist die sichere Richtung: OneTimer nimmt dann den
...
mod tests {
    ...
    #[test]
    fn triton_advertises_what_onetimer_needs() {
