...
use onetimer_core::model::ContractError;
use onetimer_core::queue::QueueConfigError;
use onetimer_core::slots::SlotError;
...
/// gemeint ist — und `onetimer doctor` soll genau das ersparen (Spec 23).
