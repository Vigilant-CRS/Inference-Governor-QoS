...
use onetimer_core::profile::{RuntimeProfile, VariantProfile};
...
pub struct StreamSpec {
    ...
    /// Queue-Policy unter OneTimer. Die Baseline nutzt immer FIFO.
    ...
    /// Queue-Kapazitaet unter OneTimer.
    pub capacity: usize,
...
impl Scenario {
    ...
    /// Die Modellvertraege fuer OneTimer: je Strom die konfigurierte Policy.
    #[must_use]
    pub fn onetimer_contracts(&self) -> ArrayVec<ModelContract, MAX_MODELS> {
