//! # OneTimer Discrete-Event Simulator
//!
...
//!    beginnt.
//!
//! Der Simulator ist die **Best-Case-Welt** fuer OneTimer: perfekte
...
// sollen, gelten fuer `onetimer-core` und bleiben dort in Kraft.
