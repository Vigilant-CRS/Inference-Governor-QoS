...
//! Wuerde OneTimer mehr Arbeit weiterreichen, als das Backend gleichzeitig
...
impl SlotSet {
    ...
    /// Bis wann ein Co-Run-Verbot den Start von `model` blockiert.
    ...
    /// Meldet den Abschluss eines Requests und gibt den Kredit zurueck.
    ///
