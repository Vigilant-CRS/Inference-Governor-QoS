...
//!
//! ## Warum OneTimer hier ueberhaupt etwas tut
//!
//! Auf dem Shm-Pfad traegt ein Inferenzrequest keine Tensordaten, sondern nur
//! eine Referenz: Regionsname, Offset, Groesse. OneTimer reicht diese Angaben
...
//! liegen. Ohne Buchfuehrung waere OneTimer die Stelle, an der diese Information
//! verloren geht.
//!
...
//! Zweifel wuerde OneTimer eine Region abmelden, die ein anderer noch benutzt.
//! Das waere schlimmer als ein Leck. Stattdessen wird der Bestand gefuehrt und
//! sichtbar gemacht; `onetimer serve` meldet beim Herunterfahren ab, was es
//! selbst kennt.
...
impl ShmRegistry {
    ...
    /// bestaetigt hat. Andernfalls fuehrte OneTimer Regionen, die es nicht gibt.
