...
| NV-17 Gültigkeitsbewusster DAG | **erreichbar, mit bekanntem Fehler**: der Client nennt `vig_capture_id` und `vig_depends_on`; eine Zusammenführung über Aufnahmegrenzen wird abgelehnt, bevor sie rechnet. Aber der Actor schließt Graphknoten nie ab — nach 256 Aufnahmen je Prozess wird jede weitere abgelehnt. Gefunden live von der ROS-2-Brücke, Korrektur in Arbeit | [0028](adr/0028-a-fusion-needs-a-common-capture.md), [Clientparameter](getting-started.md#results-from-the-same-capture) |
