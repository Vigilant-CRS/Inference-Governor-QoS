...
| [0046](0046-a-minimum-runtime-is-paid-by-lower-classes.md) | Eine Mindestlaufzeit wird von den nachrangigen Klassen bezahlt | Spec 10.6, ADR-0012, ADR-0014, ADR-0027, ADR-0043 | Akzeptiert, opt-in |
